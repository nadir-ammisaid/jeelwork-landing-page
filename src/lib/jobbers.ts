...
export async function getRecentJobbers(): Promise<Jobber[]> {
  ...
  return [
    { id: '1', name: 'Yacine B.', trade: 'Plombier',     wilaya: 'Alger',    city: 'El Biar',  rating: 4.8, avatar: '/images/avatars/nadir.jpeg' },
    { id: '2', name: 'Imad K.',   trade: 'Électricien',  wilaya: 'Oran',     city: 'Bir El Djir', rating: 4.7, avatar: '/images/avatars/nadir.jpeg' },
    { id: '3', name: 'Sara M.',   trade: 'Peintre',      wilaya: 'Constantine', city: 'El Khroub', rating: 4.9, avatar: '/images/avatars/nadir.jpeg' },
    { id: '4', name: 'Hichem D.', trade: 'Climatisation', wilaya: 'Sétif',   city: 'El Eulma', rating: 4.6, avatar: '/images/avatars/nadir.jpeg' },
  ];
}
