// criticalStyles.css.ts - Version ultra-minifiée (1.65Ko) - Above the fold uniquement
...
.burger{display:none;cursor:pointer;padding:.5rem;z-index:101;background:none;border:none}
...
.btn{background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;padding:1rem;min-width:17rem;border:none;border-radius:.75rem;display:inline-block;cursor:pointer;font-size:1em;font-weight:600;text-align:center;text-decoration:none;transition:all .3s ease}
@media (max-width:430px){.navbar{justify-content:space-between}.burger{display:flex}.logo{margin-left:auto}.container{padding:0 .9375rem}.hero h1{font-size:2rem}.hero p{font-size:1.1rem}.nav-links{display:none}}
`;