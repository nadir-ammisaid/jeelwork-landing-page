...
/* Header de page service (cohérent globals) */
.service-header { text-align: center; padding: 0 0 1rem; }
...
/* Neutraliser le hover sur la carte détail (cohérent globals) */
.service-card.service-detail-card:hover {
...
@media (max-width: 430px) {
  ...
  .services-grid { display: none; } /* carrousel non inclus en critical */
}
