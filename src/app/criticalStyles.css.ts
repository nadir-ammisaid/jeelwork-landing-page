...
.btn {
  ...
  box-shadow: 0 .25rem 1.9375rem rgba(255, 255, 255, 0.6);
}
.btn:hover {
  transform: translateY(-.125rem);
  box-shadow: 0 .5rem 1.5625rem rgba(99, 102, 241, 0.4);
  color: #fff;
}
...
/* === Recent Jobbers (règles minimales pour éviter l’overflow au 1er rendu) === */
.recent-jobbers-grid {
  display: grid;
...
@media (max-width: 430px) {
  ...
  /* Jobbers: pile verticale pour éviter tout débordement au 1er paint */
  .recent-jobbers-grid {
    display: flex;
    flex-direction: column;
    gap: 1rem;
...
@media (min-width: 431px) and (max-width: 1024px) {
  ...
  /* Jobbers: 2 colonnes compressibles, pas d’overflow */
  .recent-jobbers-grid {
...
/* Desktop (non nécessaire d'ajouter plus ici pour le critical ; le détail vient de globals.css) */
`;
